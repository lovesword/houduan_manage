...
Vue.component('position', {
    ...
    template: '<li class="ui-draggable" title="点击进行修改,拖动交换位置."><div v-on:click="del_left(index)" class="deleteButton"></div><div v-on:click="onc_banner(index)" class="position"><img v-if="is_display==2" src="'+ host +'addons/sqtg_sun/public/static/menu/images/pos.png"> <div v-if="is_display==1" class="wrap"> <em class="fr iconfont icon-arrow-right"></em> <span class="title"><i class="Hui-iconfont Hui-iconfont-weizhi"></i>{{position_name}}</span> </div> </div></li>',
    methods: {
        //删除
        del_left: function (index) {
            bannerVM.all_data.splice(index,1);
...
Vue.component('comment_s', {
    props: ['index'],
    template: '<li title="点击进行修改,拖动交换位置" class="ui-draggable"><div v-on:click="del_left(index)" class="deleteButton"></div><img v-on:click="onc_banner(index)" src="'+ host +'addons/sqtg_sun/public/static/menu/images/comment.jpg"></li>',
    methods: {
        //删除
        del_left: function (index) {
            bannerVM.all_data.splice(index,1);
...
Vue.component('store_door', {
    ...
    template: '<li title="点击进行修改,拖动交换位置" class="ui-draggable"><div v-on:click="del_left(index)" class="deleteButton"></div><div  v-on:click="onc_banner(index,$event)"  class="widget_wrap" style="padding:5px"><div style="display:flex;"><img style="width:50px;height:50px" :src="imgurl"  class="top-img"><div style="flex:1;font-size:12px;"><div class="title-name">{{door_name}}</div><div>工作时间:<span class="time">{{door_job}}</span><div class="shop_phone_icon"><img style="width:100%;height:100%" src="'+host+'addons/sqtg_sun/public/static/menu/images/shop_phone_icon.png"></div></div></div></div></div></li>',
    methods: {
        //删除
        del_left: function (index) {
            bannerVM.all_data.splice(index,1);
...
/*
 ...
 props: ['index','imgurl','door_name','door_job'],
 template: '<li title="点击进行修改,拖动交换位置" class="ui-draggable"><div v-on:click="del_left(index)" class="deleteButton"></div><div  v-on:click="onc_banner(index,$event)"  class="widget_wrap" style="padding:5px"><div style="display:flex;"><img style="width:50px;height:50px" :src="imgurl"  class="top-img"><div style="flex:1;font-size:12px;"><div class="title-name">{{door_name}}</div><div>工作时间:<span class="time">{{door_job}}</span><div class="shop_phone_icon"><img src="'+host+'addons/sqtg_sun/public/static/menu/images/shop_phone_icon.png"></div></div></div></div></div></li>',
 methods: {
 //删除
 del_left: function (index) {
 bannerVM.all_data.splice(index,1);
...
var bannerVM = new Vue({
    ...
    data: {
        ...
        dh_color: '#ffffff',
        dbj_color: '#ffffff',
        bag_url: host+ "addons/sqtg_sun/public/static/menu/images/black.png",
        win_color:'#ffffff',
        win_img:'',
    ...
    methods: {
        ...
        click_position_wz:function () {
            layui.use('table', function () {
                lay_open('坐标', hosts+'c=site&a=entry&do=Chome&op=pagemap&m=sqtg_sun','800px', '600px');
            })
        },
        ...
        select_menu:function (index,type) {
            ...
            layui.use('table', function () {
                layer.open({
                    ...
                    area: ['800px', '600px'],
                    content:hosts+'c=site&a=entry&do=Chome&op=pageselect&m=sqtg_sun&select_id=' + index + '&this_type='+type
                });
            });
        ...
        select_goods:function (index,type) {
            ...
            layui.use('table', function () {
                ...
                layer.open({
                    ...
                    maxmin: true, //开启最大化最小化按钮
                    area: ['800px', '600px'],
                    content:hosts+'c=site&a=entry&do=Chome&op=shopselect&m=sqtg_sun&select_id=' + index + '&this_type='+type
                });
            });
        },
        // 选择单个门店详情
        select_shop_info: function(index,type) {
            ...
            layui.use('table', function () {
                layer.open({
                    ...
                    maxmin: true, //开启最大化最小化按钮
                    area: ['800px', '600px'],
                    content:hosts+'c=site&a=entry&do=Chome&op=storeselect&m=sqtg_sun&select_id=' + index + '&this_type='+type
                });
            });
        },
        // 选择单个优惠券详情
        select_coupons_info: function(index,type) {
            ...
            layui.use('table', function () {
                layer.open({
                    ...
                    maxmin: true, //开启最大化最小化按钮
                    area: ['800px', '600px'],
                    content:hosts+'c=site&a=entry&do=Chome&op=couponselect&m=sqtg_sun&select_id=' + index + '&this_type='+type
                });
            });
        },
        //底部导航
        select_di_menu: function (index) {
            layui.use('table', function () {
                layer.open({
                    ...
                    maxmin: true, //开启最大化最小化按钮
                    area: ['800px', '600px'],
                    content:hosts+'c=site&a=entry&do=Chome&op=pageselect&m=sqtg_sun&select_id=' + index + '&this_type=isfoot'
                });
            });
        },
    }
...
$.ajax({
    type: "post",
    url:  hosts+'c=site&a=entry&do=Chome&op=getHomepage&m=sqtg_sun',
    ...
    success : function(res) {
        ...
        if (res.data) {
            ...
            bannerVM.all_data = [{
                ...
                "ly_height": "3",
                "juedui_height": "93",
                "topimg": host + "/addons/sqtg_sun/public/static/menu/images/Lb.jpg",
                "list": [{
                  "imgurl": host + "/addons/sqtg_sun/public/static/menu/images/Lb2.png",
                  "jiaodian_color": "#be0000",
                  "top": 0,
                  "img_dis": "none",
                  "this_type": "banner"
                ...
                "list": [{
                  ...
                  "img": host + "/addons/sqtg_sun/public/static/menu/images/11red.PNG",
                  "top": 0
                }, {
                  "this_type": "tripartite",
                  "img": host + "/addons/sqtg_sun/public/static/menu/images/21blue.PNG",
                  "top": 135
                }, {
                  "this_type": "tripartite",
                  "img": host + "/addons/sqtg_sun/public/static/menu/images/21yellow.PNG",
                  "top": 270
                }],
            ...
            if (list.length == 0) {
                list = [{
                    imgurl:"/sqtg_sun/pages/home/index/index",
                    key: "index",
                    name: "首页",
                    linkname: "首页",
                    name_this: undefined,
                    page_icon: host + "addons/sqtg_sun/public/static/menu/images/footnav/a.png",
                    page_select_icon: host + "addons/sqtg_sun/public/static/menu/images/footnav/ah.png",
                    top: 0
                },
                {
                    imgurl:"/sqtg_sun/pages/home/classify/classify",
                    key: "index",
                    name: "分类",
                    linkname: "分类",
                    name_this: undefined,
                    page_icon: host + "addons/sqtg_sun/public/static/menu/images/footnav/b.png",
                    page_select_icon: host + "addons/sqtg_sun/public/static/menu/images/footnav/bh.png",
                    top: 0
                },
                {
                    imgurl:"/sqtg_sun/pages/home/shopcar/shopcar",
                    key: "index",
                    name: "购物车",
                    linkname: "购物车",
                    name_this: undefined,
                    page_icon: host + "addons/sqtg_sun/public/static/menu/images/footnav/c.png",
                    page_select_icon: host + "addons/sqtg_sun/public/static/menu/images/footnav/ch.png",
                    top: 0
                },
                {
                    imgurl:"/sqtg_sun/pages/home/my/my",
                    key: "index",
                    name: "我的",
                    linkname: "我的",
                    name_this: undefined,
                    page_icon: host + "addons/sqtg_sun/public/static/menu/images/footnav/d.png",
                    page_select_icon: host + "addons/sqtg_sun/public/static/menu/images/footnav/dh.png",
                    top: 0
                }]
            } else {
                var a = [];
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==1){
        ...
        //右边向当前数组中增加数据
        var item = {};
        item['imgurl'] = host + "addons/sqtg_sun/public/static/menu/images/Lb2.png";
        ...
        new_item['topimg']=host + "addons/sqtg_sun/public/static/menu/images/Lb.jpg";
        new_item['list'] = arr;
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==2){
        ...
        new_item['ly_height']="3";
        new_item['juedui_height']="93";
        new_item['topimg']=host+ "addons/sqtg_sun/public/static/menu/images/Ad.jpg";
        new_item['list'] = arr;
        new_item['time_key'] = Date.parse(new Date())/1000+""+Math.round(Math.random()*100000);
        bannerVM.all_data.push(new_item);
        //获取当前增加的幻灯片下标
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==3){
        ...
        bannerVM.add_top=145;
        var item = {};
        item['imgurl'] = host+ "addons/sqtg_sun/public/static/menu/images/Lb21.png";
        item['top'] = 0;
        item['name'] = '名称';
        item['alias'] = '链接';
        ...
        new_item['topimg']=host+ "addons/sqtg_sun/public/static/menu/images/Ggdh1.png";
        new_item['list'] = arr;
        new_item['time_key'] = Date.parse(new Date())/1000+""+Math.round(Math.random()*100000);
        bannerVM.all_data.push(new_item);
        //获取当前增加的幻灯片下标
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==8){
        ...
        item['imgurl']=host+ "addons/sqtg_sun/public/static/menu/images/Tpj_3.png";
        item['top']=0;
        var arr=[];
        arr.push(item);
        //左边幻灯片增加数据
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==10){
        ...
        item['imgurl']=host+ "addons/sqtg_sun/public/static/menu/images/kefu.png";//显示图片
        item['name']='点击选择链接';
        var arr=[];
        arr.push(item);
        //左边幻灯片增加数据
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==13){
        ...
        item['imgurl'] = host+ "addons/sqtg_sun/public/static/menu/images/Tplb_3.png";
        item['top'] = 0;
        item['title'] = '标题';
        item['name'] = '链接至';
        var arr=[];
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==24){
        ...
        new_item['imgurl'] = host+ "addons/sqtg_sun/public/static/menu/images/service_icon.png";
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==25){
        ...
        new_item['form_transparent']="1";
        new_item['form_icon_transparent']="1";
        new_item['imgurl'] = host+ "addons/sqtg_sun/public/static/menu/images/tel_icon.png";
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==14){
        ...
        item['imgurl'] = host+ "addons/sqtg_sun/public/static/menu/images/kefu.png";
        item['name']="点击选择链接";
        var arr=[];
        arr.push(item);
        //左边幻灯片增加数据
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==19){
        ...
        item['img']=host+ "addons/sqtg_sun/public/static/menu/images/11red.PNG";
        item['top'] =0;
        var item1 = {};
        item1['this_type']="tripartite";
        item1['img']=host+ "addons/sqtg_sun/public/static/menu/images/21blue.PNG";
        item1['top'] = 135;
        var item2 = {};
        item2['this_type']="tripartite";
        item2['img']=host+ "addons/sqtg_sun/public/static/menu/images/21yellow.PNG";
        item2['top'] = 270;
        var arr=[];
        arr.push(item);
        arr.push(item1);
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==20){
        ...
        item['img']=host+ "addons/sqtg_sun/public/static/menu/images/23blue.PNG";
        item['top'] =0;
        var item1 = {};
        item1['this_type']="quartet";
        item1['img']=host+ "addons/sqtg_sun/public/static/menu/images/11blue.PNG";
        item1['top'] = 135;
        var item2 = {};
        item2['this_type']="quartet";
        item2['img']=host+ "addons/sqtg_sun/public/static/menu/images/11red.PNG";
        item2['top'] = 270;
        var item3 = {};
        item3['this_type']="quartet";
        item3['img']=host+ "addons/sqtg_sun/public/static/menu/images/11yellow.PNG";
        item3['top'] = 405;
        var arr=[];
        arr.push(item);
        arr.push(item1);
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==26){
        ...
        new_item['imgurl'] = host+ "addons/sqtg_sun/public/static/menu/images/hotdot.png";
        new_item['bg_color']="#ffffff";
        new_item['color']="#000000";
        new_item['title']="";
        new_item['time_key'] = Date.parse(new Date())/1000+""+Math.round(Math.random()*100000);
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==27){
        ...
        //左边幻灯片增加数据
        var new_item ={};
        new_item['img']=host+ "addons/sqtg_sun/public/static/menu/images/tencent_app.jpg";
        new_item['type']="ad";
        new_item['ad_id']="0";
        new_item['height']="140";
        new_item['time_key'] = Date.parse(new Date())/1000+""+Math.round(Math.random()*100000);
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==22){
        ...
        new_item['door_phone']="";
        new_item['imgurl']=host+ "addons/sqtg_sun/public/static/menu/images/business.png";
        new_item['time_key'] = Date.parse(new Date())/1000+""+Math.round(Math.random()*100000);
        bannerVM.all_data.push(new_item);
        bannerVM.now_index = bannerVM.all_data.length-1;
...
$(".j-diy-addModule").click(function () {
    if($(this).attr('data-type')==23){
        ...
        new_item['imgurl']=host+ "addons/sqtg_sun/public/static/menu/images/choose_form.jpg";
        new_item['param']="0";
        new_item['time_key'] = Date.parse(new Date())/1000+""+Math.round(Math.random()*100000);
        bannerVM.all_data.push(new_item);
        bannerVM.now_index = bannerVM.all_data.length-1;
...
get_position = function(lat,lng) {
    bannerVM.all_data[bannerVM.now_index]['latitude']=lat;
    bannerVM.all_data[bannerVM.now_index]['longitude']=lng;
    $('#longitude').val(lng);
    $('#latitude').val(lat);
}
//获取pagesURL
...
save_template = function(event) {
    ...
    layui.use('table', function () {
        ...
        html2canvas(document.querySelector("#contents"),{
            ...
            $.ajax({
                type : "post",
                url : hosts+'c=site&a=entry&do=Chome&op=save_tem&m=sqtg_sun',
                data : param,
                success : function(data) {
                   if(data['code']==0){
        ...
        html2canvas(document.querySelector("#contents"),{
            ...
            layer.prompt({title: '输入模版名称', formType: 0}, function (text, index) {
                var param = {
                 ...
                 $.ajax({
                    type : "post",
                    url : hosts+'c=site&a=entry&do=Chome&op=add_mytem&m=sqtg_sun',
                    data : param,
                    success : function(data) {
                       if(data['code']==0){
...
setTimeout(function(){
    ...
    $('#BtColorDefault').click(function () {
        ...
        bannerVM.bag_url = host+ "addons/sqtg_sun/public/static/menu/images/black.png";
    ...
    $('#BtColorCustom').click(function () {
        ...
        bannerVM.bag_url = host+ "addons/sqtg_sun/public/static/menu/images/white.png";
