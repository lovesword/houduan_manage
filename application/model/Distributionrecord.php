...
//                    计算一级分佣
                ...
                $distribution_amount1 = round($ordergoods['pay_amount'] * $distribution_rate_level1/100,2);
...
//                        二级
                    ...
                    if ($user_id2 && User::isDistribution($user_id2)){
                        ...
                        $distribution_amount2 = round($ordergoods['pay_amount'] * $distribution_rate_level2 /100,2);
                        ...
                        if ($distribution_level >= 3) {
                            ...
                            if ($user_id3 && User::isDistribution($user_id3)) {
                                ...
                                $distribution_amount3 = round($ordergoods['pay_amount'] * $distribution_rate_level3 /100 ,2);
    ...
    public function onOrdergoodsFinish($ordergoods){
        Distributionrecord::update(['state'=>2])
            ->where([
                'state'=>1,
                'order_id'=>$ordergoods->order_id,
                'goods_id'=>$ordergoods->id,
